...
3. **Access the Network Tab**: Navigate to the Network tab and filter by `browse?prettyPrint=false`.
4. **Select a Request**: Click one of the requests under the filtered results, check your "Headers" tab (NOT on the "Request" Tab), then check the Request Headers section.
5. **Toggle RAW View**: Click the RAW toggle((should be on the right edge of the section)) button to view the headers in raw format. Sample image below.<img width="740" height="381" alt="image" src="https://github.com/user-attachments/assets/d20cc674-d889-4618-872f-ab5d52f8f209" />
